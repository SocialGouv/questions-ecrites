"""simplify question clusters: replace run-based tables with a single flat table

Revision ID: f2a3b4c5d6e7
Revises: e1f2a3b4c5d6
Create Date: 2026-03-25

Drops question_cluster_runs and question_cluster_members in favour of a single
question_clusters table that is fully replaced on each clustering run.
"""
